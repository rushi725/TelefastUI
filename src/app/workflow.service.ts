...
export class WorkflowService {
  ...
  createWorkflow() {
      ...
      const startingTasks: Array<any> = this.workFlow.filter(e => !e.prevTask);
      const currentTasks: Array<any> = this.orderedTasks.filter(t => startingTasks.find(e => e.task.id === t.task.id));
